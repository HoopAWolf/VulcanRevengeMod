...
public class EntityHelper
{
    ...
    public <T extends Entity> List<T> getEntitiesNearbyWithPos(World world, AxisAlignedBB box, BlockPos pos, Class<T> entityClass, double dX, double dY, double dZ, double r)
    {
